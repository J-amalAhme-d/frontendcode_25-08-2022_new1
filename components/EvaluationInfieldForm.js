...
function EvaluationInfieldForm (props) {
...
const handleFormFilled = (formValues) => {
  ...
  addInfieldEvaluation(formValues);
}

const addInfieldEvaluation = (evaluationForm) => {
  APICaller.apiUpsertPlayerEvaluation(event, player_bib_id,"INFIELD",evaluationForm)
    .then(aupeR => {
...
export default EvaluationInfieldForm;
