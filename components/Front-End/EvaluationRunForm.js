...
const handleFormFilled = (formValues) => {
  ...
  addRunningEvaluation(formValues);
}

const addRunningEvaluation = (evaluationForm) => {
  APICaller.apiUpsertPlayerEvaluation(event, player_bib_id,"RUNNING",evaluationForm)
    .then(aupeR => {
