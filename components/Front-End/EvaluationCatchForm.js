...
function EvaluationCatchForm (props) {
...
const handleFormFilled = (formValues) => {
  ...
  addCatchEvaluation(formValues);
}

const addCatchEvaluation = (evaluationForm) => {
  APICaller.apiUpsertPlayerEvaluation(event, player_bib_id,"CATCH",evaluationForm)
    .then(aupeR => {
...
export default EvaluationCatchForm;
