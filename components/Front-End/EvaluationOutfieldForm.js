...
function EvaluationOutfieldForm (props) {
...
const handleFormFilled = (formValues) => {
  ...
  addOutfieldEvaluation(formValues);
}

const addOutfieldEvaluation = (evaluationForm) => {
  APICaller.apiUpsertPlayerEvaluation(event, player_bib_id,"OUTFIELD",evaluationForm)
    .then(aupeR => {
...
export default EvaluationOutfieldForm;
