...
function EvaluationPitchForm (props) {
...
const handleFormFilled = (formValues) => {
  ...
  addPitchEvaluation(formValues);
}

const addPitchEvaluation = (evaluationForm) => {
  APICaller.apiUpsertPlayerEvaluation(event, player_bib_id,"PITCH",evaluationForm)
    .then(aupeR => {
...
export default EvaluationPitchForm;
